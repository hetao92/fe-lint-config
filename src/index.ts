...
// ESLint 主函数
export const OBEslintCfg: EslintFactoryModule['OBEslintCfg'] = function (
  ...args
) {
  return getEslintFactory().OBEslintCfg(...args);
} as EslintFactoryModule['OBEslintCfg'];

export const resolveSubOptions: EslintFactoryModule['resolveSubOptions'] =
  function (...args) {
    return getEslintFactory().resolveSubOptions(...args);
  } as EslintFactoryModule['resolveSubOptions'];

export const getOverrides: EslintFactoryModule['getOverrides'] = function (
  ...args
) {
